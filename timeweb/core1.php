...
if(!isset($_GET['api']))register_shutdown_function(static function():void{
  echo '<link rel="stylesheet" href="mobile-design.css?v=20260807a"><script>window.showResult=function(html){var el=document.getElementById("result");if(el)el.innerHTML=html;};</script><script src="engine.js?v=20260805d"></script><script src="engine-compat.js?v=20260805d"></script><script src="engine-zones.js?v=20260805d"></script><script src="engine-exact.js?v=20260805d"></script><script src="engine-favorable.js?v=20260805d"></script><script src="engine-favorable-hook.js?v=20260805d"></script><script src="engine-runtime.js?v=20260805d"></script><script src="trajectory-hover.js?v=20260806b"></script><script src="mobile-design.js?v=20260807a"></script>';
});
