...
if(!isset($_GET['api']))register_shutdown_function(static function():void{
  echo '<script src="engine.js?v=20260805b"></script><script src="engine-compat.js?v=20260805b"></script><script src="engine-zones.js?v=20260805b"></script><script src="engine-exact.js?v=20260805b"></script><script src="engine-favorable.js?v=20260805b"></script><script src="engine-favorable-hook.js?v=20260805b"></script>';
});
